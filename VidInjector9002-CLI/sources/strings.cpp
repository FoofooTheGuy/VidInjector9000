...
std::string SsInfoText = "Similar to -sp, this reads the titles from an SMDH and sets them to short name, long name, and publisher in the output .vi9p file. Useful for when first using an SMDH for the icon (Output file can be the same as input file)";
...
std::string FailedToCreateDirectory = "Failed to create the directory:";
std::string DirectoryExists = "The directory already exists and is not empty";
...
std::string maximumRows = "The maximum amount of rows as been reached";
