...
namespace VidInjector9002 {
    ...
    public:
        ...
        void doAppendMedia() {
            ...
            removemedia.location({ removemedia.location().x(), text_box_array.at((rows - 1) * columns + (columns - 1))->location().y() + text_box_array.at((rows - 1) * columns + (columns - 1))->height() + moflexbrowse.height() + 2 });
