...
std::string ExtendedMulti = "Extended multi video";
...
std::string MenuBannerText = "Top image";
...
std::string bannerBrowseTip = "Select the image to be shown on the home menu top screen (200x120)";
std::string iconBoxTip = "The path of the image to be shown on the home menu bottom screen";
std::string iconBrowseTip = "Select the image to be shown on the home menu bottom screen (48x48)";
...
std::string multiBannerPreviewTip = "Select the image to replace this";
...
std::string topImageTip = "The path of the image to be shown in the top screen of the extended multi video menu";
...
std::string moflexBrowseTip = "Select the .moflex file to insert";
std::string multiBannerBrowseTip = "Select the image to insert (200x120)";
std::string extendedTopImageBrowseTip = "Select the image to insert (400x240)";
