...
bool loadLanguage(std::string LangPath) {
	...
	if (filelines.size() == 0)
		return false;
	std::vector<std::string*> inLangVec = { &inLangLanguage, &inLangErrorText, &inLangMissingVariableError, &inLangFailedToFindVar, &inLangValueNoChange, &inLangBadValue, &inLangBadVersion, &inLangSupportedVersion, &inLangBeANumber, &inLangframeText, &inLanglogFrameText, &inLangbuildFrameText, &inLangaboutFrameText, &inLangfile, &inLangfileNew, &inLangfileOpen, &inLangfileSave, &inLangfileSaveAs, &inLangfileExport, &inLangfileExtract, &inLangfileImportSeed, &inLangoptions, &inLangoptionsShowLog, &inLangoptionsSystemMode, &inLangoptionsLightMode, &inLangoptionsDarkMode, &inLanglanguage, &inLanghelp, &inLanghelpAbout, &inLangReturn, &inLangModeText, &inLangSingleVideo, &inLangMultiVideo, &inLangBrowse, &inLangBannerText, &inLangIconText, &inLangShortNameText, &inLangLongNameText, &inLangPublisherText, &inLangCopyrightCheckText, &inLangBannerCustomText, &inLangBannerPreviewText, &inLangFFrewindCheckText, &inLangDimCheckText, &inLangTextTooLongError, &inLangImageInfoError, &inLangCopyFileError, &inLangCLIError, &inLangBuildError, &inLangExtractError, &inLangSeeLog, &inLangFileSaved, &inLangPlayerTitleText, &inLangMoflexFileText, &inLangMenuBannerText, &inLangSplitIntoAPatch, &inLangTitleIDText, &inLangApplicationTitleText, &inLangProductCodeText, &inLangBuild, &inLangCancel, &inLangSuccessfullyBuilt, &inLangSuccessfullyExtracted, &inLangextractingArchive, &inLangclickCancel, &inLangByMeText, &inLangGitHubLinker, &inLangonlyMultiVideo, &inLangmodeChoiceBoxTip, &inLangbannerBoxTip, &inLangbannerBrowseTip, &inLangiconBoxTip, &inLangiconBrowseTip, &inLangshortnameBoxTip, &inLanglongnameBoxTip, &inLangpublisherBoxTip, &inLangcopyBoxTip, &inLangcopyCheckTip, &inLangiconPreviewTip, &inLangffRewindCheckTip, &inLangdimCheckTip, &inLangmultiBannerPreviewTip, &inLangmultiBannerPreviewLeftTip, &inLangmultiBannerPreviewRightTip, &inLangmoflexFileTip, &inLangplayerTitlesTip, &inLangmoflexFilesTip, &inLangmenuBannersTip, &inLangmultiUpTip, &inLangmultiDownTip, &inLangmoflexBrowseTip, &inLangmultiBannerBrowseTip, &inLangremoveRowTip, &inLangappendRowTip, &inLangsplitPatchTip, &inLangsplitPatchUpTip, &inLangsplitPatchDownTip, &inLangtitleIDBoxTip, &inLangtitleIDButtonTip, &inLangapplicationTitleBoxTip, &inLangproductCodeBoxTip, &inLangchooseDirSave, &inLangmoflexFiles, &inLangextractFiles, &inLangvi9pFiles, &inLangciaFiles, &inLangtarFiles, &inLangseeddbFiles, &inLangallFiles, };
	std::vector<std::string*> LangVec = { &Language, &ErrorText, &MissingVariableError, &FailedToFindVar, &ValueNoChange, &BadValue, &BadVersion, &SupportedVersion, &BeANumber, &frameText, &logFrameText, &buildFrameText, &aboutFrameText, &file, &fileNew, &fileOpen, &fileSave, &fileSaveAs, &fileExport, &fileExtract, &fileImportSeed, &options, &optionsShowLog, &optionsSystemMode, &optionsLightMode, &optionsDarkMode, &language, &help, &helpAbout, &Return, &ModeText, &SingleVideo, &MultiVideo, &Browse, &BannerText, &IconText, &ShortNameText, &LongNameText, &PublisherText, &CopyrightCheckText, &BannerCustomText, &BannerPreviewText, &FFrewindCheckText, &DimCheckText, &TextTooLongError, &ImageInfoError, &CopyFileError, &CLIError, &BuildError, &ExtractError, &SeeLog, &FileSaved, &PlayerTitleText, &MoflexFileText, &MenuBannerText, &SplitIntoAPatch, &TitleIDText, &ApplicationTitleText, &ProductCodeText, &Build, &Cancel, &SuccessfullyBuilt, &SuccessfullyExtracted, &extractingArchive, &clickCancel, &ByMeText, &GitHubLinker, &onlyMultiVideo, &modeChoiceBoxTip, &bannerBoxTip, &bannerBrowseTip, &iconBoxTip, &iconBrowseTip, &shortnameBoxTip, &longnameBoxTip, &publisherBoxTip, &copyBoxTip, &copyCheckTip, &iconPreviewTip, &ffRewindCheckTip, &dimCheckTip, &multiBannerPreviewTip, &multiBannerPreviewLeftTip, &multiBannerPreviewRightTip, &moflexFileTip, &playerTitlesTip, &moflexFilesTip, &menuBannersTip, &multiUpTip, &multiDownTip, &moflexBrowseTip, &multiBannerBrowseTip, &removeRowTip, &appendRowTip, &splitPatchTip, &splitPatchUpTip, &splitPatchDownTip, &titleIDBoxTip, &titleIDButtonTip, &applicationTitleBoxTip, &productCodeBoxTip, &chooseDirSave, &moflexFiles, &extractFiles, &vi9pFiles, &ciaFiles, &tarFiles, &seeddbFiles, &allFiles, };
